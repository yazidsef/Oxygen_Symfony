...
final class Version20240220105533 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE new_message (id INT AUTO_INCREMENT NOT NULL, student_id INT NOT NULL, message LONGTEXT NOT NULL, INDEX IDX_6DFE6391CB944F1A (student_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE new_message ADD CONSTRAINT FK_6DFE6391CB944F1A FOREIGN KEY (student_id) REFERENCES student (id)');
        ...
        $this->addSql('ALTER TABLE new_messages DROP FOREIGN KEY FK_9C6B92BACB944F1A');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE new_messages (id INT AUTO_INCREMENT NOT NULL, student_id INT NOT NULL, message LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, INDEX IDX_9C6B92BACB944F1A (student_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE new_messages ADD CONSTRAINT FK_9C6B92BACB944F1A FOREIGN KEY (student_id) REFERENCES student (id)');
        ...
        $this->addSql('ALTER TABLE new_message DROP FOREIGN KEY FK_6DFE6391CB944F1A');
