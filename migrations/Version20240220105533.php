...
final class Version20240220105533 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE application (id INT AUTO_INCREMENT NOT NULL, course_id INT DEFAULT NULL, avatar_image VARCHAR(255) NOT NULL, first_name VARCHAR(150) NOT NULL, last_name VARCHAR(150) NOT NULL, tel INT NOT NULL, email VARCHAR(255) NOT NULL, degree VARCHAR(150) NOT NULL, birthday DATETIME NOT NULL, message LONGTEXT NOT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_A45BDDC1591CC992 (course_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
