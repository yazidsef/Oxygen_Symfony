...
final class Version20240219181414 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE discipline (id INT AUTO_INCREMENT NOT NULL, icon VARCHAR(255) NOT NULL, name VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, url_image VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE new_messages (id INT AUTO_INCREMENT NOT NULL, student_id INT NOT NULL, message LONGTEXT NOT NULL, INDEX IDX_9C6B92BACB944F1A (student_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE student (id INT AUTO_INCREMENT NOT NULL, course_id INT NOT NULL, applications_id INT NOT NULL, first_name VARCHAR(150) NOT NULL, last_name VARCHAR(150) NOT NULL, tel INT NOT NULL, degree VARCHAR(150) NOT NULL, birthday DATETIME NOT NULL, adress VARCHAR(255) NOT NULL, avatar_image VARCHAR(255) NOT NULL, formation VARCHAR(255) NOT NULL, INDEX IDX_B723AF33591CC992 (course_id), INDEX IDX_B723AF3329A0022 (applications_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
